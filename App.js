...
export default class MyDatePicker extends Component {
  ...
  render() {
    return (
       <View style={{backgroundColor:"green",height:700,width:350}}>
   <Text style={{color:"black",fontSize:25,justifyContent:"center",alignSelf:"center",margin:40}}>Date Picker</Text>
